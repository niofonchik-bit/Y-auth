	...
	en: {
		translation: {
			...
			auth: {
				...
				brandSubtitle: 'Centralized authentication for modern teams.',
				brandFeatureSso: 'SSO & OAuth 2.0 / OIDC',
				brandFeatureMfa: 'MFA, passkeys & recovery codes',
				brandFeatureAudit: 'Full audit log & compliance',
				joinToday: 'Join Y.auth today',
				or: 'or',
				createAccount: 'Create account',
				continueTo: 'Continue to {{client}}',
				email: 'Email address',
				password: 'Password',
			...
			errors: {
				...
				MFA_CODE_INVALID: 'Неверный код приложения или восстановления.',
			},
		},
	},
	ru: {
		translation: {
			...
			auth: {
				...
				brandSubtitle: 'Централизованная аутентификация для современных команд.',
				brandFeatureSso: 'SSO и OAuth 2.0 / OIDC',
				brandFeatureMfa: 'MFA, passkeys и коды восстановления',
				brandFeatureAudit: 'Полный аудит и контроль событий',
				joinToday: 'Присоединиться к Y.auth',
				or: 'или',
				createAccount: 'Создать аккаунт',
				continueTo: 'Продолжить в {{client}}',
				email: 'Email',
				password: 'Пароль',
