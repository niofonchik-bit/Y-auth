...
if (process.env.BENCHMARK_LIVE === 'true') {
  ...
  try {
    ...
    process.stdout.write(
      'Repository, session-list and rate-limit timings require seeded BENCHMARK_LIVE infrastructure.\n',
    );
  } finally {
    await app.close();
  }
  ...
  process.stdout.write(
    'API/database/Redis benchmark skipped. Set BENCHMARK_LIVE=true with isolated infrastructure.\n',
  );
}
